...
const HeroCarousel = () => {
  ...
  return (
    ...
    >
            ...
            <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center max-w-7xl mx-auto">
                ...
                <div className="text-white z-10 text-center lg:text-left order-2 lg:order-1">
                  ...
                  {/* Series Badge - Mobile friendly */}
                  <div className="inline-flex items-center px-3 py-1 mb-4 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
      ...
      <div className="absolute bottom-16 sm:bottom-20 lg:bottom-24 left-1/2 transform -translate-x-1/2 flex space-x-2 sm:space-x-3">
        {slides.map((_, index) => (
          <button
            key={index}
